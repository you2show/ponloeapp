...
export const MiscView: React.FC<MiscViewProps> = ({ setView }) => {
      ...
      <div className="max-w-3xl mx-auto p-4 space-y-4">
        ...
        <div className={`p-6 rounded-2xl border ${
          ...
          <p className={`font-khmer leading-relaxed ${theme === 'dark' ? 'text-slate-200' : 'text-slate-800'}`}>
            ផ្នែកនេះនឹងបង្ហាញអំពីចំណេះដឹងទូទៅ និងច្បាប់បញ្ញត្តិផ្សេងៗនៅក្នុងសាសនាអ៊ីស្លាមដែលអ្នកមូស្លីមគួរស្វែងយល់។
          </p>
        </div>
