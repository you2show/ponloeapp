              ...
              <div className="relative z-10 text-center w-full max-w-xl mx-auto flex flex-col gap-4 md:gap-6">
                 <p 
                   ...
                   style={{ 
                     ...
                     fontFamily: quranFont === 'Uthmani' ? 'Amiri, serif' : 
                                 quranFont === 'Uthman Naskh' ? '"Uthman Naskh", serif' :
                                 quranFont === 'Uthman Hafs' ? '"Uthman Hafs", serif' :
                                 quranFont === 'IndoPak' ? '"IndoPak Nastaleeq", serif' : 'sans-serif'
                   }}
                   dir="rtl"
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in max-w-3xl mx-auto">
                  <div>
                    ...
                    >
                       ...
                       <option value="Uthman Naskh">Uthman Naskh</option>
                       <option value="Uthman Hafs">Uthman Hafs</option>
